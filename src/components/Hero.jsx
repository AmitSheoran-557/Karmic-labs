...
const Hero = () => {
    return (
        <div className='relative'>
            ...
            <Header />
            <div className='bg-hero-bg bg-center relative z-10 min-h-[726px] w-full bg-no-repeat xl:pt-[124px] lg:pt-20 md:pt-16 pt-14 lg:pb-4'>
                    ...
                    <div className="flex flex-wrap w-full lg:mb-0">
                        <div className="lg:w-7/12 w-full flex flex-col justify-center xl:items-start items-center">
                            <div className='lg:text-start text-center'>
                                <h1 className='xl:!text-[64px] lg:text-4xl text-3xl xl:max-w-[570px] lg:max-w-lg font-light lg:mb-[13px] mb-2 !leading-[108%] text-white uppercase'>We are believers decentralization and <span className='relative'>Web3.<img className='absolute xl:-top-3 lg:-top-2 -top-1.5 xl:left-6 lg:left-3 left-2 max-xl:max-w-24 max-lg:max-w-20' src={LinesImgThree} alt="top-line-img" /><img className='absolute xl:-bottom-2 -bottom-1 xl:right-6 lg:right-4 right-2 max-xl:max-w-24 max-lg:max-w-20' src={LinesImgFour} alt="bottom-line-img" /></span>  </h1>
