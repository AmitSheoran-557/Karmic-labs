...
const projects = () => {
    return (
        <div className='relative bg-white-bg max-w-[1440px] lg:bg-cover bg-center max-lg:bg-white mx-auto xl:pb-[121px] lg:pb-20 md:pb-16 pb-12 bg-no-repeat xl:pt-24 lg:pt-20 md:pt-16 pt-12'>
            <div className="w-full mx-auto max-xl:px-4 max-w-[1150px]">
                ...
                <div className="flex flex-wrap w-full mx-auto lg:gap-y-6 gap-y-4 justify-center items-center xl:pb-14 lg:pb-12 md:pb-7 pb-4">
                    {PROJECT_SECTION_IMAGE_LIST.map((obj, index) => (
                        <div className="xl:w-3/12 lg:w-4/12 md:w-6/12 w-full flex max-xl:px-3 justify-center items-center" key={index}>
                            <div className='overflow-hidden group xl:hover:scale-[1.25] lg:hover:scale-[1.1] hover:scale-[1.07] hover:z-50 lg:hover:-translate-y-2 relative group transition-all ease-linear duration-300'>
                                <div className='rounded-lg overflow-hidden relative'>
                                    <img className='xl:max-w-[273px] rounded-lg max-sm:max-w-80 w-full' src={obj.image} alt="img" />
